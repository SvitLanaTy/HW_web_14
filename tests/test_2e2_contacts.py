...
def test_create_contact(client, get_token, monkeypatch):
    with patch.object(auth_service, "cache") as redis_mock:
        ...
        response = client.post("api/contacts",
                               json={"first_name": "test", "last_name": "test","email":"test@gmail.com",                              "phone_number":"+380123456789",
                                     "birthday": str(datetime.now().date()),"extra_data": "test"},
                               headers=headers)
        ...
        assert data["phone_number"] == "+380123456789"
